  ...
  return (
    <div class=" grid lg:grid-cols-2 grid-cols-1 md:grid-cols-2 gap-1">
      <div className="flex items-center   ">
        ...
        <span className="w-1 h-10 mx-1 bg-slate-700 block"></span>
        <h3 className="text-xl  capitalize ">Vehicle Repaired</h3>
      </div>

      <div className="flex items-center">
        <h1 className="text-3xl font font-bold mr-1 ">5</h1>
        <span className="w-1 h-10 mx-1 bg-slate-700 block"></span>
        <h3 className="text-xl  capitalize ">Years of experience</h3>
      </div>
